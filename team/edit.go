...
// チーム編集リクエスト（チーム選択）
func getBlocksEditTeamSelect() []slack.Block {
	// チームデータ 読み込み
...
func getBlocksEditTeamInfo(actionUserID string, blockActions map[string]map[string]slack.BlockAction) []slack.Block {
	var (
		md  data.MembersData
		td  data.TeamsData
		err error
